...
public class DrawingBoard extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void setCurAction(float x, float y) {
        switch (mActionType) {
            case Point:
                curAction = new MyPoint(x, y, currentColor, currentSize);
                break;
            case Path:
            ...
            case Line:
                ...
                break;
            case Rect:
                curAction = new MyRect(x, y, currentColor, currentSize);
                break;
            case Circle:
                curAction = new MyCircle(x, y, currentColor, currentSize);
                break;
            case FillEcRect:
                curAction = new MyFillRect(x, y, currentColor, currentSize);
                break;
            case FilledCircle:
                curAction = new MyFillCircle(x, y, currentColor, currentSize);
                break;
            default:
                break;
        }
     ...
     * @return 图片的保存路径
     */
    public String saveBitmap(DrawingBoard doodleView) {
